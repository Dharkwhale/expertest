...
### GAP-008 — `?state=` review switch makes 4 routes render dynamically, and ships to production

- **Category:** tech-debt
- **Severity:** low
- **Location:** `src/lib/view-state.ts:11`; used by `src/app/(tabs)/home/page.tsx:26`, `explore/page.tsx:13`, `src/app/welcome/page.tsx:20`, `src/app/(detail)/events/[eventId]/page.tsx:27`
